...
<p id="preview-notice">
	<?php printf( __( 'Vous visualisez un aperçu de <strong>%1$s</strong>. ', 'anthologize' ), $preview_title, add_query_arg( array( 'page' => 'anthologize/includes/class-export-panel.php' ), admin_url( 'admin.php' ) ) ) ?>
</p>
