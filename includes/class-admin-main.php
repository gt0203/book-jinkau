...
class Anthologize_Admin_Main {
	...
	function dashboard_hooks() {
		...
		$this->add_admin_menu_page( array(
			'menu_title'   => __( 'Editeur Book', 'anthologize' ),
	...
	function display() {
		...
		<div id="anthologize-logo"><img src="<?php echo esc_url( plugins_url() . '/anthologize/images/logo-jinkau-300px.png' ) ?>" /></div>
