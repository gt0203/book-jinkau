...
class Anthologize_Export_Panel {
	...
	function display() {
		...
		<div id="anthologize-logo"><img src="<?php echo plugins_url() . '/anthologize/images/logo-jinkau-300px.png' ?>" /></div>
			...
			<label for="project_id"><?php _e( 'sélectionner un projet', 'anthologize' ) ?></label>
			...
			<table class="form-table">
				...
				<tr valign="top">
					...
					<td>
						<input type="radio" id="ctype" name="ctype" value="c" <?php if ( $ctype == 'c' ) echo 'checked="checked"' ?>/> <?php _e( 'Copyright', 'anthologize' ) ?>
					</td>
				</tr>
			...
			<form action="" method="post">
				...
				<div id="export-format">
					<h4><?php _e( 'Format d\'exportation', 'anthologize' ) ?></h4>
