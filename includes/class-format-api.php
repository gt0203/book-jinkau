...
function anthologize_register_default_formats() {
	...
	anthologize_register_format( 'pdf', __( 'PDF (conseillé)', 'anthologize' ), WP_PLUGIN_DIR . '/anthologize/templates/pdf/base.php' );

	anthologize_register_format_option( 'pdf', 'page-size', __( 'Page Size', 'anthologize' ), 'dropdown', $d_page_size, 'letter' );

	anthologize_register_format_option( 'pdf', 'font-size', __( 'Taille de la police', 'anthologize' ), 'dropdown', $d_font_size, '12' );

	anthologize_register_format_option( 'pdf', 'font-face', __( 'Font Face', 'anthologize' ), 'dropdown', $d_font_face_pdf, 'Times New Roman' );

	anthologize_register_format_option( 'pdf', 'break-parts', __( 'Page blanche avant les articles ?', 'anthologize' ), 'checkbox' );

	anthologize_register_format_option( 'pdf', 'break-items', __( 'Page blanche après les articles ?', 'anthologize' ), 'checkbox' );
	...
	// anthologize_register_format_option( 'rtf', 'font-size', __( 'Taille de la police', 'anthologize' ), 'dropdown', $d_font_size, '12' );
	// anthologize_register_format_option( 'rtf', 'font-face', __( 'Font Face', 'anthologize' ), 'dropdown', $d_font_face_pdf, 'Times New Roman' );
	// anthologize_register_format_option( 'rtf', 'break-parts', __( 'Page blache avant les articles ?', 'anthologize' ), 'checkbox' );
	// anthologize_register_format_option( 'rtf', 'break-items', __( 'Page blache après les articles ?', 'anthologize' ), 'checkbox' );

	// Register ePub.
	// anthologize_register_format( 'epub', __( 'ePub', 'anthologize' ), WP_PLUGIN_DIR . '/anthologize/templates/epub/index.php' );

	// anthologize_register_format_option( 'epub', 'font-size', __( 'Taille de la police', 'anthologize' ), 'dropdown', $d_font_size, '12' );
